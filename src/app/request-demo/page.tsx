...
export const metadata = buildMeta({
  ...
  description: 'Request a live demo of SpecForge. See provenance tracking, policy enforcement, and OSS risk mapping in action.',
    ...
    <div className="mx-auto max-w-2xl px-4 py-16 md:px-6 md:py-24">
      <section className="text-center">
        ...
        <p className="mx-auto mt-6 max-w-xl text-lg text-muted">
          See how SpecForge helps engineering teams track AI-generated code, map OSS dependencies, and enforce governance policies. We will respond within one business day.
        </p>
      </section>
